...
func main() {
	...
	handlers.StartCustomSqlExportCleanupScheduler()
	...
	api := r.Group("/api")
	{
		...
		protected.Use(handlers.AuthMiddleware())
		{
			...
			protected.GET("/key-customers", handlers.GetKeyCustomersHandler)
			protected.POST("/key-customers/toggle", handlers.ToggleKeyCustomerHandler)
			protected.PUT("/key-customers/warning-threshold", handlers.SetKeyCustomerWarningThresholdHandler)
			protected.GET("/key-customer-balance", handlers.QueryKeyCustomerBalanceHandler)
